...
<body>
	<div id="Content">
		...
		<?php
			echo "Konto urzytkownika ".$_GET['login']." zostało utworzone! <br> Hasło tymczasowe to: ".$_GET['pass']." Nie zapomnij go zapisać. Po zalogowaniu otrzymasz możliwość zmiany hasła.";
		?>
		</span>
