<?php
	...
	if(isset($_GET['title']) == false && isset($_GET['author']) == false && isset($_GET['buid']) == false)
	{
...
<body>
	<div id="Content">
		...
		<?php
			echo 'Książka o tytule "'.$title.'" autora "'.$author.'" została dodana od bazy i posiada UID "'.$buid.'".';
		?>
		</span>
