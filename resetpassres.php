<?php
	...
	if(isset($_GET['login']) == false && isset($_GET['pass']) == false)
	{
...
<body>
	<div id="Content">
		...
		<h1>Zmodyfikowano konto!</h1>
		<?php
			echo "Konto urzytkownika ".$_GET['login']." zostało zmodyfikowane! <br> Nowe hasło tymczasowe to: ".$_GET['pass']." Nie zapomnij go zapisać. Po zalogowaniu otrzymasz możliwość zmiany hasła.";
		?>
		</span>
